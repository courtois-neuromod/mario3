#!/usr/bin/env python
"""Generate annotated BIDS event files for the mario3 dataset.
...
Usage:
    python generate_annotations.py -d /path/to/mario3
...
def main() -> int:
    ...
    parser.add_argument("-d", "--datapath", default=".",
                        help="Root of the mario3 dataset.")
