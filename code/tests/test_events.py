"""Event-file tests for the mario3 dataset.
...
def test_sidecar_present_and_complete():
    ...
    sidecar = op.join(DATAPATH, f"task-mario3_events.json")
...
def test_every_emitted_type_is_allowed_for_this_task():
    ...
    assert not wrong, f"trial_types not allowed for mario3: {wrong[:10]}"
